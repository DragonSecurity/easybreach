...
use easybreach_bloom::bloom::{bloom_get, EasyBloom};
...
pub struct Opt {
    #[structopt(long = "bloomfile", default_value = "easybreach.bloom")]
    bloomfile: String,
...
async fn main() -> ::anyhow::Result<(), ::anyhow::Error> {
    ...
    let axum_handle = axum::Server::bind(&addr).serve(app.into_make_service());
